...
echo ============================================================
echo  Charles Schwab Documents - sign in
echo ============================================================
if not "%~1"=="" echo Account: %~1
echo.
echo A normal Chromium window will open. Then:
echo   1. Sign in to Charles Schwab (do all the 2FA / verification yourself).
...
echo.
.venv\Scripts\python.exe schwab_docs.py --open-browser %CFG%
echo.
pause
